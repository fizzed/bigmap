...
public class RocksBigMapTest {
    ...
    public void putGetWithStrings() {
        final Map<String,String> map = new RocksBigMapBuilder()
    ...
    public void putGetWithLongs() {
        final Map<Long,String> map = new RocksBigMapBuilder()
            .setScratchDirectory(Paths.get("target"))
    ...
    public void firstKey() {
        final SortedMap<Long,String> map = new RocksBigMapBuilder()
            .setScratchDirectory(Paths.get("target"))
            .setKeyType(Long.class)
            .setValueType(String.class)
            .build();
